    ...
    def base_state(self):
        return {
            ...
            "next_step": {
                ...
                "readiness": "ready",
                "prerequisites": [{"name": "resume_check.py", "kind": "repo_file", "verify_scope": "ci", "status": "verified", "evidence": {"method": "test fixture", "checked_at": "2026-09-20", "blob_sha": "REPLACE_ME"}}],
            },
